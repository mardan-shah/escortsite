      ...
      <Card className='w-48 shadow-md relative'>
        ...
        <CardFooter className='bg-white p-0 h-6 rounded-lg'>
          <div className="w-full px-3">
            <div className="flex items-center justify-between px-0 text-[14px] text-gray-700/90 font-semibold">
              <span className='flex items-center justify-start gap-1'><Euro width={15} height={15} />{profile.price}</span>
              <span className='flex gap-1 justify-center items-center'><Image src='/Cards/age.svg' width={15} height={15} alt='img' />{profile.age} y/o</span>
              <span className="flex gap1 justify-end items-center"><Image src='/Cards/scale.svg' width={15} height={15} alt='img' />{profile.height}</span>
            </div>
          </div>
        </CardFooter>
      </Card>
