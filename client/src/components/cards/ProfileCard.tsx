        ...
        <Link href="#" className="group relative block">
          ...
          <div className="absolute inset-x-0 top-0 flex items-start justify-between p-2">
            ...
            <div className="flex items-center rounded bg-black/60 px-2 py-1">
              <Heart className="mr-1 h-4 w-4 fill-current text-yellow-400" />
              <span className="text-xs font-medium text-white">{profile.rating}</span>
            </div>
            
            {/* Like button */}
            <button className="rounded-full bg-black/60 p-2 text-white transition-colors hover:text-pink-500">
